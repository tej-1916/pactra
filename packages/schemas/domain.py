...
class EventType(str, Enum):
    ...
    PAYMENT_PROVIDER_UNCERTAIN = "PAYMENT_PROVIDER_UNCERTAIN"
    ...
    OUTBOX_EVENT_DEAD_LETTERED = "OUTBOX_EVENT_DEAD_LETTERED"
...
class ReasonCode(str, Enum):
    ...
    AUTHORIZATION_SIGNATURE_MALFORMED = "AUTHORIZATION_SIGNATURE_MALFORMED"
    ...
    PROVIDER_CREATE_FENCED = "PROVIDER_CREATE_FENCED"
    PROVIDER_PAYMENT_ATTEMPT_FAILED = "PROVIDER_PAYMENT_ATTEMPT_FAILED"
    ...
    WEBHOOK_EVENT_ID_MISSING = "WEBHOOK_EVENT_ID_MISSING"
    WEBHOOK_PAYLOAD_INVALID = "WEBHOOK_PAYLOAD_INVALID"
    WEBHOOK_DUPLICATE = "WEBHOOK_DUPLICATE"
    WEBHOOK_UNKNOWN_PAYMENT = "WEBHOOK_UNKNOWN_PAYMENT"
