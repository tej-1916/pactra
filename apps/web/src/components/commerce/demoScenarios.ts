...
export const DEMO_SCENARIOS: Record<Exclude<ScenarioId, "LIVE_RUNTIME">, DemoScenario> = {
  BENIGN_PURCHASE: {
    ...
    execute: {
      ...
      nextAction: "NONE",
      providerEvidence: "razorpay_pay_test_98a21c",
    },
    decisionTrace: [
      {
        stage: "ADMIT",
        ...
        verdict: "ACCEPTED",
        reason_codes: ["SCHEMA_VALID", "POLICY_SATISFIED"],
        invariant_id: null,
      ...
      },
      {
        ...
        verdict: "ACCEPTED",
        reason_codes: ["CANONICAL_DIGEST_BOUND", "OFFER_VERSION_VERIFIED"],
        invariant_id: null,
        approval_scheme: "POLICY_AUTO",
        policy_outcome: "ALLOW",
      ...
      },
      {
        ...
        verdict: "SUCCEEDED",
        reason_codes: ["IDEMPOTENT_DISPATCH_CONFIRMED", "PROVIDER_EVIDENCE_VERIFIED"],
        invariant_id: null,
        approval_scheme: "POLICY_AUTO",
        policy_outcome: "ALLOW",
    ...
    decisionTrace: [
      {
        ...
        event_type: "POLICY_DECISION",
        verdict: "ACCEPTED",
        reason_codes: ["SCHEMA_VALID", "EXCEEDS_SOFT_BUDGET"],
        invariant_id: null,
      ...
      },
      {
        ...
        verdict: "PENDING",
        reason_codes: ["CANONICAL_DIGEST_BOUND", "AWAITING_ED25519_SIGNATURE"],
        invariant_id: null,
        approval_scheme: "USER_ED25519",
        policy_outcome: "REQUIRE_APPROVAL",
        payment_state: "CREATED",
  ...
  PROVIDER_LOST: {
    ...
    decisionTrace: [
      ...
      },
      {
        ...
        event_type: "AUTHORIZATION_CREATED",
        verdict: "ACCEPTED",
        reason_codes: ["CANONICAL_DIGEST_BOUND"],
        invariant_id: null,
        approval_scheme: "POLICY_AUTO",
        policy_outcome: "ALLOW",
        payment_state: "QUEUED",
      ...
      },
      {
        ...
        verdict: "PENDING",
        reason_codes: ["PROVIDER_TIMEOUT_OR_UNREACHABLE", "AWAITING_RECONCILIATION"],
        invariant_id: null,
        approval_scheme: "POLICY_AUTO",
        policy_outcome: "ALLOW",
