...
export function ProvenanceLegend({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "grid gap-3 rounded-md border border-[color:var(--color-line)] bg-[color:var(--color-surface-2)] p-3 sm:grid-cols-2",
        className,
      )}
    >
      <div>
        ...
        <p className="mt-1 max-w-[52ch] text-[11.5px] leading-snug text-[color:var(--color-ink-3)]">
